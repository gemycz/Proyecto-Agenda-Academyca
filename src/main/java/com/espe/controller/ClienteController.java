...
public class ClienteController {
	...
	public List<Cliente> obtenerClientes() {
		...
		/*
		 * List<Cliente> listaClientes = new ArrayList<Cliente>(); Cliente c1 = new
		 * Cliente(); Cliente c2 = new Cliente();
		 * 
		 * 
		 * c1.setIdCliente(1); c1.setNombreCli("Gema"); c1.setApellidoCli("Castillo");
		 * c1.setCedulaCli("1313602920");
		 * 
		 * c2.setIdCliente(2); c2.setNombreCli("Santiago"); c2.setApellidoCli("Perez");
